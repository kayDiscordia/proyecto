                                ...
                                <?php foreach ($actividades as $actividad): ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="p-3 text-sm text-gray-700">
                                            <?php
                                            // Colores iguales a las demás vistas
                                            $estadoClases = [
                                            ...
                                            $clase = $estadoClases[$actividad['estado']] ?? 'bg-gray-100 text-gray-800';
                                            ?>
    ...
    <script>
        ...
        flatpickr("#fecha_inicio", {
            ...
            onChange: function(selectedDates, dateStr, instance) {
                // Al cambiar la fecha de inicio, actualizar el minDate de fecha_fin
                if (selectedDates.length > 0) {
                    fechaFinPicker.set('minDate', dateStr);
                } else {
                    fechaFinPicker.set('minDate', null);
                }
            }
        });

        // Guardar la instancia de flatpickr para fecha_fin
        ...
        document.getElementById('exportarPDF').addEventListener('click', function() {
            ...
            const empleado = "<?= htmlspecialchars($infoEmpleado->nombres . ' ' . $infoEmpleado->apellidos) ?>";
            ...
            doc.autoTable({
                ...
                didDrawPage: function(data) {
                    ...
                    doc.text('Reporte de Actividades del Empleado', 32, 20);
                    doc.setFontSize(10);
                    doc.text('Empleado: ' + empleado, 32, 25);
