...
<body class="bg-[#E8EEFF]">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function mostrarListadoActividades(fecha, actividadesDia) {
                ...
                html += '</ul>';
                Swal.fire({
                    title: `Actividades del ${fecha.toLocaleDateString()}`,
                    html: html,
                    width: 500,
                            ...
                            btn.addEventListener('click', function(e) {
                                ...
                                `,
                                    ...
                                    if (result.dismiss === Swal.DismissReason.cancel) {
                                        mostrarListadoActividades(fecha, actividadesDia);
                                    }
                                });
                            });
                        });
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function(info) {
                    // Al hacer click en un evento, mostrar el listado de actividades del día
                    const fechaClic = info.event.startStr.substr(0, 10);
                    ...
                    mostrarListadoActividades(fechaObj, actividadesDia);
                },
                dateClick: function(info) {
                    ...
                    if (actividadesDia.length > 0) {
                        mostrarListadoActividades(info.date, actividadesDia);
                    } else {
                        Swal.fire({
                ...
                eventDidMount: function(info) {
                    // Deshabilitar el puntero y click en el "+x más"
