...
class modeloEmpleado
{
    ...
    public function obtenerTodasActividadesPorEmpleado($idEmpleado)
    {
        try {
            $query = "SELECT 
                    a.idActividad,
            ...
            error_log("Error en obtenerTodasActividadesPorEmpleado: " . $e->getMessage());
            throw new Exception("No se pudieron obtener todas las actividades del empleado");
        }
    }
